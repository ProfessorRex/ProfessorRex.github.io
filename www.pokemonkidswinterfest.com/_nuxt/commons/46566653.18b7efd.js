    ...
    [1], {
        ...
        651: function(t, e, n) {
            ...
            var m = {
                    ...
                    beforeDestroy: function() {
                        this.iframeRef = null, delete this.iframeRef, this.eventListen = window.removeEventListener("gamedata", this.gameEvent), this.eventListen = null, this.analyticsListen = window.removeEventListener("analyticsEvent", this.gameAnalytics), this.analyticsListen = null, delete this.eventListen, this.iframeAlive = !1, delete this.iframeAlive, this.startSeconds = 0, delete this.startSeconds, this.endSeconds = 0, delete this.endSeconds
                    },
                    destroyed: function() {},
                    mounted: function() {
                        var t = this;
                        this.$store.commit("setMusicEnabled", !1);
                        var e = new Date;
                        this.startSeconds = Math.round(e.getTime() / 1e3), e = null, this.iframeRef = this.$refs.iframe, setTimeout((function() {
                            t.initialShow = !0
                        }), 200), setTimeout((function() {
                            t.iframeRef.focus()
                        }), 400), this.eventListen = window.addEventListener("gamedata", this.gameEvent), this.analyticsListen = window.addEventListener("analyticsEvent", this.gameAnalytics), this.trackEvent("".concat(this.game), "Game Opened", this.game), this.trackEvent("".concat(this.game), "Game Started", this.game), "scene-creator" != this.game && "pair-up" != this.game && this.trackEvent("".concat(this.game), "Choosen Pokemon", this.allPokemon[this.pokemon - 1].enname)
                    },
                    computed: function(t) {
                        for (var i = 1; i < arguments.length; i++) {
                            var source = null != arguments[i] ? arguments[i] : {};
                ...
                component = Object(d.a)(m, (function() {
                    ...
                    return n("div", {
                        ...
                        attrs: {
                            src: "/games/test/" + t.game + ".html?pokemon=" + t.pokemon + "&goldenRazzberryActive=" + (2 == t.week) + "&game=" + t.game + "&day=" + t.day + "&week=" + t.week + "&lang=" + t.lang + "&mute=" + t.mute + "&team=" + t.team + "&sceneCreatorSave=" + ("scene-creator" == t.game ? t.sceneCreatorSave : "")
                        }
                    }) : n("iframe", {
                        ref: "iframe",
                        staticClass: "the-iframe",
                        attrs: {
                            src: "/games/" + t.game + "/index.html?pokemon=" + t.pokemon + "&goldenRazzberryActive=" + (2 == t.week || 4 == t.week) + "&game=" + t.game + "&day=" + t.day + "&week=" + t.week + "&lang=" + t.lang + "&mute=" + t.mute + "&team=" + t.team + "&sceneCreatorSave=" + ("scene-creator" == t.game ? t.sceneCreatorSave : "")
                        }
                    })]) : t._e()])
                }), [], !1, null, null, null);
            e.default = component.exports
