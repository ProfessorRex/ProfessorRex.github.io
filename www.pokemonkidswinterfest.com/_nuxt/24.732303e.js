    ...
    [24], {
        537: function(e, t, n) {
            ...
            var a = function(u) {
                ...
                function s(e, t) {
                    var a, n;
                    return void 0 === t && (t = {}), (a = u.call(this) || this).t = {}, a.i = 0, a.o = new c, a.u = new c, a.s = new c, a.v = 0, a.h = new Set, a.l = function() {
                        var e = a.g,
                            t = e.installing;
                        ...
                        !r && a.j && (o.isUpdate = !0), a.dispatchEvent(new v(u + i, o)), "installed" === i ? a.O = self.setTimeout((function() {
                            "installed" === i && t.waiting === n && a.dispatchEvent(new v(u + "waiting", o))
                        }), 200) : "activating" === i && (clearTimeout(a.O), r || a.u.resolve(n))
                    }, a.R = function(e) {
                        var t = a.p;
                        t === navigator.serviceWorker.controller && (a.dispatchEvent(new v("controlling", {
                            sw: t,
                            originalEvent: e,
                            isUpdate: a.j
                        })), a.s.resolve(t))
                        ...
                        return f(a.getSW(), (function() {
                            a.h.has(n) && a.dispatchEvent(new v("message", {
                                data: t,
                                sw: n,
                                originalEvent: e
                            }))
                ...
                return l.register = function(e) {
                    ...
                    try {
                        ...
                        return function(e, t) {
                            ...
                            if (!n && "complete" !== document.readyState) return h(new Promise((function(e) {
                                return window.addEventListener("load", e)
                            })))
                        }), (function() {
                            return u.j = Boolean(navigator.serviceWorker.controller), u.U = u.B(), f(u.L(), (function(e) {
                    ...
                    try {
                        ...
                        return function(e, t) {
                            ...
                            return f(navigator.serviceWorker.register(e.m, e.t), (function(t) {
