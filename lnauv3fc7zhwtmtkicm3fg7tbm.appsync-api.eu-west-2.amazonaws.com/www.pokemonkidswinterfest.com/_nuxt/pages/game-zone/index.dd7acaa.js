            ...
            var S = {
                    ...
                    data: function() {
                        return {
                            ...
                            showOtherScreensAfterWelcomeBack: !1
                        }
                    },
                    created: function() {
                    ...
                    mounted: function() {
                        var t = this;
                        this.enableAPI && !this.guestMode && this.$store.dispatch("getAllTeamRaceData"), this.trackPageView("Game Zone"), this.$store.commit("setActiveMusic", "gamezone"), this.$store.commit("setMusicEnabled", !0), this.localRazzberries = parseInt(this.razzberries), setTimeout((function() {
                            t.checkShowWelcomeScreen()
                        }), 100), this.achievementProgressScreen(), this.lastWeekVisisted < this.week && !this.guestMode && this.userDayJoined != this.day && this.week < 6 && (this.activateEventScreen = !0), this.firstTime.games && (setTimeout((function() {
                    ...
                    methods: {
                        ...
                        checkShowWelcomeScreen: function() {
                            var t = this;
                            this.week < 7 && !this.guestMode && (!1 !== this.lastDayVisisted ? this.isPageRefresh ? setTimeout((function() {
                                t.lastDayVisisted < t.day ? (t.$store.commit("resetUserHighscores"), t.week < 6 ? (t.showWelcomeBack = !0, t.showOtherScreensAfterWelcomeBack = !0, t.$store.commit("updateLastDayVisisted")) : t.openCampaignEndScreen = !0) : (t.showWelcomeBack = !0, t.showOtherScreensAfterWelcomeBack = !1)
                            }), 2e3) : setTimeout((function() {
                                t.lastDayVisisted < t.day && (t.$store.commit("resetUserHighscores"), t.week < 6 ? (t.showWelcomeBack = !0, t.showOtherScreensAfterWelcomeBack = !0, t.$store.commit("updateLastDayVisisted")) : t.openCampaignEndScreen = !0)
                            }), 2e3) : this.$store.commit("updateLastDayVisisted"))
                        },
                        closeShowWelcomeBack: function() {
                            this.showWelcomeBack = !1, this.week < 6 && this.showOtherScreensAfterWelcomeBack && (this.activateUnlockScreen = !0)
                        },
                        gotoMenu: function() {
                            var t = this;
                ...
                T = (n(672), n(36)),
                component = Object(T.a)(S, (function() {
                    var t = this,
                        e = t.$createElement,
                        n = t._self._c || e;
                    return n("div", {
